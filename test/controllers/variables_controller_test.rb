...
class VariablesControllerTest < ActionController::TestCase
  ...
  test "should create variable" do
    assert_difference('Variable.count') do
      post :create, variable: { data_file_id: @variable.data_file_id, name: @variable.name, type: @variable.type }
    end
  ...
  test "should update variable" do
    patch :update, id: @variable, variable: { data_file_id: @variable.data_file_id, name: @variable.name, type: @variable.type }
    assert_redirected_to variable_path(assigns(:variable))
  end
