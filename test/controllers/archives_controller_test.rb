...
class ArchivesControllerTest < ActionController::TestCase
  ...
  test "should create archive" do
    assert_difference('Archive.count') do
      post :create, archive: { after: @archive.after, before: @archive.before, count: @archive.count, name: @archive.name }
    end
  ...
  test "should update archive" do
    patch :update, id: @archive, archive: { after: @archive.after, before: @archive.before, count: @archive.count, name: @archive.name }
    assert_redirected_to archive_path(assigns(:archive))
  end
